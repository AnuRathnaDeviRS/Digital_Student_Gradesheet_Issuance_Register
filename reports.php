...
<!-- 
           ...
           <div class="first" onclick="window.location.href='date.php';">
                <a href="date.php" style="display: inline-block; margin-top: 50px;color:black">By Date</a>
           </div>
           <div class="first" onclick="window.location.href='batch.php';">
                <a href="batch.php" style="display: inline-block; margin-top: 50px;color:black">By batch</a>
           </div>
           <div class="first" onclick="window.location.href='stu.php';">
                <a href="stu.php" style="display: inline-block; margin-top: 50px;color:black">By Student</a>
           </div>
